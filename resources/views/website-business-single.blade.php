...
$mainImg = $business->business_img ? asset('storage/' . ltrim($business->business_img, '/')) : asset('images/1.jpg');
                        ...
                        <div class="list-single-main-item fl-wrap">
                            ...
                            <div class="list-single-main-item_content fl-wrap">
                                ...
                                <div style="margin-top:18px; display:flex; gap:12px; flex-wrap:wrap;">
                                    @if ($business->industry && $business->industry->slug)
                                        <a href="{{ route('seo.industry.show', $business->industry->slug) }}"
                                            class="btn small-btn color-bg">More {{ $industryName }} Businesses</a>
                                    @endif
                                    @if (!empty($business->country))
                                        <a href="{{ route('seo.country.show', \Illuminate\Support\Str::slug($business->country)) }}"
                                            class="btn small-btn" style="background:#f3f4f6;color:#111827;">Browse {{ $business->country }}</a>
                                    @endif
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="faq-section">
                                        @foreach ($faqItems as $faq)
                                            <div style="margin-bottom:18px;">
                                                <h4 style="margin-bottom:8px;">{{ $faq['question'] }}</h4>
                            ...
                            document.addEventListener("DOMContentLoaded", function() {
                                document.querySelectorAll(".enq-status-btn").forEach(function(btn) {
                                    btn.addEventListener("click", function(e) {
                                        ...
                                        // Toggle show/hide
                                        el.style.display = (el.style.display === "none" || el
                                                .style.display === "") ?
                                            "block" : "none";
                                    });
                                });
                                        ...
                                        <div class="row" style="display:flex; flex-wrap:wrap;">
                                            ...
                                            <div class="col-md-12" style="margin-bottom:20px;">
                                                ...
                                                <textarea name="message" cols="40" rows="3"
                                                    placeholder="Your inquiry message and any specific questions..."
                                                    required
                            ...
                            <ul class="no-list-style">
                                ...
                                <li>
                                    <div class="widget-posts-img">
                                        <a href="{{ route('seo.business.show', $item->slug) }}">
                                            <img src="{{ $itemImg }}" alt="">
                                        </a>
                                    </div>
                                    <div class="widget-posts-descr">
                                        <h4>
                                            <a
                                                href="{{ route('seo.business.show', $item->slug) }}">{{ $itemTitle }}</a>
                                        </h4>
                                        <div class="geodir-category-location fl-wrap">
