...
@section('title')
    <title>All Enquiries | Mergersales</title>
@endsection
...
@section('content')
        ...
        <div class="card shadow-sm border-0 rounded-3">
            <div class="card-header d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <small class="text-muted">All Inquire on Your Business</small>
                </div>
            </div>
            ...
            <div class="card-body">
                                        ...
                                        <td>
                                            @if ($enquiry->listing)
                                                <div class="fw-semibold">
                                                    {{ $enquiry->listing->business_name }}
                                                </div>
                                                <div class="text-muted" style="font-size:12px;">
                                                    {{ $enquiry->listing->deal_type }} - {{ $enquiry->listing->country }}
                                                </div>
                                            @else
                                    ...
                                    <div class="card border-0 shadow-sm mb-3" id="m_nda_wrap" style="display:none;">
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex gap-2 flex-wrap">
                                                <a id="m_download_nda" class="btn btn-outline-primary btn-sm"
                                                    href="#" style="display:none;">
                                                    Download NDA
                                                </a>

                                                <a id="m_download_signed" class="btn btn-outline-success btn-sm"
                                                    href="#" style="display:none;">
                                                    Download Signed NDA
                                                </a>
                                            </div>
                ...
                @else
                    <div class="text-center py-5">
                        ...
                        <p class="text-muted">Abhi aapki listings par koi enquiry nahi aayi.</p>
                    </div>
                @endif
            </div>
        </div>
    ...
    {{-- ✅ Reuse your SAME modal HTML --}}
    @includeIf('enquire._enquiry_modal') {{-- OPTIONAL: agar aap modal ko partial me rakhna chaho --}}
    {{-- warna aap apna existing modal yahi paste kar dein --}}

    <script>
        // ✅ aapka modal JS + updateStatus + sendNda same rahega
        // Bas yahan se aap apna same script paste kar dein (jo aapne message me diya).
    </script>
    <script>
