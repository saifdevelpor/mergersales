...
@section('title')
    <title>Enquire Pending | Mergersales</title>
@endsection
...
@section('content')
    <div class="container">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h4 class="mb-0">Pending Enquiries</h4>
            </div>
            <div class="card-body">
                            ...
                            <tbody>
                                @foreach ($enquiries as $enquiry)
                                    <tr>
                                        ...
                                        <td>{{ $enquiry->listing->business_name ?? 'N/A' }}</td>
    ...
    @foreach ($enquiries as $enquiry)
        @php
            ...
            // ✅ absolute public URL (NO asset, NO buyer/enquiries issue)
            $fileUrl = $file ? url('storage/app/public/' . ltrim($file, '/')) : null;
                                ...
                                @if ($enquiry->nda_status === 'sent')
                                    ...
                                    <div class="col-12 mb-3">
                                        ...
                                        <div class="border rounded p-2 bg-white">
                                            <canvas id="sigCanvas{{ $enquiry->id }}"
