...
<head>
    ...
    <title>Login - Page | Mergersales</title>
            ...
            <div class="authentication-inner py-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="mb-1">Welcome to Mergersales! 👋</h4>
                        ...
                        <form id="formAuthentication" class="mb-4" method="POST" action="{{ route('login') }}">
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    @if (Route::has('password.request'))
                                        <a href="{{ route('password.request') }}">
                                            <p class="mb-0" style="color: #CCAA57">Forgot Password?</p>
                                        </a>
                                    @endif
                                </div>
                            </div>
                            <div class="mb-6">
                                <button class="btn d-grid w-100" type="submit"
                                    style="background: #CCAA57; color:white">Login</button>
                            </div>
                        </form>
                        <p class="text-center">
                            <span>New on our platform?</span>
                            <a href="{{ route('register') }}">
                                <span style="color: #CCAA57">Create an account</span>
                            </a>
                        </p>
                    </div>
                </div>
